...
# combine kinship vcfs


cd /lustre/scratch/jmanthey/19_bears/07_kinship
...
##########################################
##########################################
### thin for 5 kbp separation between SNPs for kinship
##########################################
##########################################

vcftools --vcf kinship.vcf --thin 5000 --recode --recode-INFO-all --out kinship
